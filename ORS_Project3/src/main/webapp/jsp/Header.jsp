<%@page import="in.co.rays.project_3.controller.LoginCtl"%> <%@page
import="in.co.rays.project_3.controller.ORSView"%> <%@page
import="in.co.rays.project_3.controller.LoginCtl"%> <%@page
import="in.co.rays.project_3.dto.RoleDTO"%> <%@page
import="in.co.rays.project_3.dto.UserDTO"%> <%@page
import="in.co.rays.project_3.controller.ORSView"%> <%@ page language="java"
    ...
    <div class="header">
      <nav class="navbar navbar-expand-lg fixed-top amit">
        <a class="navbar-brand" href="<%=ORSView.WELCOME_CTL%>">
          <img
            src="<%=ORSView.APP_CONTEXT%>/img/custom.png"
            width="190px"
            height="50px"
          />
        </a>
          ...
          <ul class="nav navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
              <a
                ...
                aria-expanded="false"
              >
                <font style="color: Black">Marksheet</font>
              </a>
            ...
            <li class="nav-item dropdown" style="padding-left: 5px">
              <a
                ...
                aria-expanded="false"
              >
                <font style="color: Black">Employee</font>
              </a>
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                <a class="dropdown-item" href="<%=ORSView.Employee_CTL%>">
                  <i class="fas fa-user-circle"></i>Add Employee
                </a>
                <a class="dropdown-item" href="<%=ORSView.Employee_LIST_CTL%>"
                  ><i class="fas fa-user-friends"></i>Employee List</a
                >
              </div>
            </li>
            <%--
            ...
            <li class="nav-item dropdown" style="padding-left: 5px">
              <a
                ...
                aria-expanded="false"
              >
                <font style="color: Black">Marksheet </font></a
              >

              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                <a class="dropdown-item" href="<%=ORSView.MARKSHEET_CTL%>">
                  <i class="far fa-file"></i>Add Marksheet
                </a>
            ...
            <li class="nav-item dropdown" style="padding-left: 5px">
              <a
                ...
                aria-expanded="false"
              >
                <font style="color: Black">Role</font>
              </a>
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                <a class="dropdown-item" href="<%=ORSView.ROLE_CTL%>">
                  <i class="fas fa-user-tie"></i>Add Role
                </a>
            ...
            <li class="nav-item dropdown" style="padding-left: 5px">
              <a
                ...
                aria-expanded="false"
              >
                <font style="color: Black">College</font>
              </a>
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <a class="dropdown-item" href="<%=ORSView.COLLEGE_LIST_CTL%>"
                  ><i class="fas fa-building"></i>College List
                </a>
              </div>
            </li>
            <li class="nav-item dropdown" style="padding-left: 5px">
              <a
                ...
                aria-expanded="false"
              >
                <font style="color: Black">Course </font></a
              >
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <a class="dropdown-item" href="<%=ORSView.COURSE_LIST_CTL%>"
                  ><i class="fas fa-sort-amount-down"></i>Course List
                </a>
              </div>
            </li>
            <li class="nav-item dropdown" style="padding-left: 5px">
              <a
                ...
                aria-expanded="false"
              >
                <font style="color: Black">Student</font>
              </a>
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <li class="nav-item dropdown" style="padding-left: 5px">
              <a
                ...
                aria-expanded="false"
              >
                <font style="color: Black">Faculty </font></a
              >
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <li class="nav-item dropdown" style="padding-left: 5px">
              <a
                ...
                aria-expanded="false"
              >
                <font style="color: Black">Time Table</font>
              </a>
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <li class="nav-item dropdown" style="padding-left: 5px">
              <a
                ...
                aria-expanded="false"
              >
                <font style="color: Black">Subject</font>
              </a>
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            >
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                >
                  <i class="fas fa-clone"></i>Java Doc
                </a>
                <% } %> 
                <% } else { %>
